    ...
    <div className="admin-add-property">
      <div className="container">
        <div className="admin-header">
          ...
          <p>Fill in all the details for the new rental property</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="property-form">
          ...
          <section className="form-section">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows="8"
                placeholder="Detailed description about the property and area"
              />
            </div>
          </section>
            ...
            <div className="add-item-section">
              <div className="bedroom-form">
                <input
                  ...
                  placeholder="Bedroom name (e.g., Master Bedroom)"
                />
                <input
                  type="text"
            ...
            <div className="add-item-section">
              <div className="add-item-form">
                <input
                  ...
                  placeholder="Space name (e.g., Garage, Deck)"
                />
                ...
                {amenityCategories.map(category => (
                  formData.amenities[category].length > 0 && (
                    <div key={category} className="category-group">
                      ...
                      <div className="items-list">
                        {formData.amenities[category].map((item, index) => (
                          <span key={index} className="item-tag">
                            {item}
            ...
            <div className="add-item-section">
              ...
              <div className="items-list">
                {formData.policies.cancellation.map((policy, index) => (
                  <div key={index} className="item-tag wide">
                    {policy}
          ...
          <div className="form-actions">
            <button type="button" onClick={() => navigate('/vacation-rentals')} className="btn-secondary">
              Cancel
            </button>
